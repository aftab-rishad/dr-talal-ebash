    ...
    <footer className="bg-stone-950 text-stone-400 py-16 px-4 md:px-8 border-t border-gold-400/25">
      <div className="max-w-7xl mx-auto space-y-12">
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          <div className="md:col-span-2 space-y-4">
            <div className="flex items-baseline gap-2">
              <span className="font-serif text-lg text-white font-semibold">Dr. Talal Ebash</span>
            ...
            <p className="text-xs leading-relaxed max-w-md text-stone-400 font-sans font-light">
              Consultant Urologist & Head of Department | Urology, Saudi German Health UAE.<br />
              Translating two decades of European clinical standards, professional hospital leadership (German Chefarzt, Leitender Oberarzt), and comprehensive surgical oncology practices to premium patient care.
            </p>
          </div>
          ...
          <div className="space-y-3.5 text-xs font-sans">
            ...
            <div className="space-y-2">
              <div className="flex items-center gap-2 text-stone-300 font-light">
                ...
                <span>Dubai Clinic: 800 22 11 (Toll-free inside UAE)</span>
              </div>
              <div className="flex items-center gap-2 text-stone-300 font-mono font-light">
                <Mail className="w-3.5 h-3.5 text-gold-500" />
                <span>t.ebash@saudigerman.com</span>
              </div>
            </div>
          </div>
          ...
          <div className="space-y-3 text-xs font-sans">
            ...
            <p className="leading-relaxed text-stone-500 text-[11px] font-light font-sans">
              ...
              Saudi German Hospital, Al Barsha 3, Dubai.<br />
              Conforming to UAE Medical Governance and International HIPAA and EAU Directives.
            </p>
          </div>
        </div>
        ...
        <div className="pt-8 border-t border-gold-400/10 flex flex-col md:flex-row items-center justify-between gap-4 text-xs font-mono text-stone-500">
          <p>
            &copy; {new Date().getFullYear()} Dr. Talal Ebash. All Rights Reserved.
          </p>
